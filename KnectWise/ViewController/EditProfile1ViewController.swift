...
class EditProfile1ViewController : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        skipBtn.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(skipBtnClicked)))
    ...
    @objc func skipBtnClicked(){
        performSegue(withIdentifier: "editInfo2Seg", sender: nil)
    }
...
extension EditProfile1ViewController : UIImagePickerControllerDelegate, UINavigationControllerDelegate,CropViewControllerDelegate {
